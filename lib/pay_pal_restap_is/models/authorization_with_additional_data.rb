...
module PayPalRestapIs
  ...
  # and processor response. These details are populated only for certain payment
  # methods.
  class AuthorizationWithAdditionalData < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      AuthorizationWithAdditionalData.new(status,
                                          status_details,
                                          id,
                                          amount,
                                          invoice_id,

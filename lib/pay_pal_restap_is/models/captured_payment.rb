...
module PayPalRestapIs
  ...
  class CapturedPayment < BaseModel
    ...
    def initialize(status = SKIP, status_details = SKIP, id = SKIP,
                   ...
                   seller_protection = SKIP, final_capture = false,
                   seller_receivable_breakdown = SKIP,
    ...
    def to_s
      ...
      " update_time: #{@update_time}, supplementary_data: #{@supplementary_data}, payee:"\
      " #{@payee}>"
    end

...
module PayPalRestapIs
  ...
  class SetupTokenResponse < BaseModel
    ...
    def initialize(id = SKIP, ordinal = SKIP, customer = SKIP,
                   status = 'CREATED', payment_source = SKIP, links = SKIP)
    ...
    def to_s
      ...
      "<#{class_name} id: #{@id}, ordinal: #{@ordinal}, customer: #{@customer}, status:"\
      " #{@status}, payment_source: #{@payment_source}, links: #{@links}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} id: #{@id.inspect}, ordinal: #{@ordinal.inspect}, customer:"\
      " #{@customer.inspect}, status: #{@status.inspect}, payment_source:"\

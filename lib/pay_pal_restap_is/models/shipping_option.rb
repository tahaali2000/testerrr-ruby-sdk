...
module PayPalRestapIs
  ...
  class ShippingOption < BaseModel
    ...
    def initialize(id = nil, label = nil, selected = nil, type = SKIP,
                   amount = SKIP)
      @id = id
      @label = label
    ...
    def to_s
      ...
      "<#{class_name} id: #{@id}, label: #{@label}, type: #{@type}, amount: #{@amount}, selected:"\
      " #{@selected}>"
    end
    ...
    def inspect
      ...
      " amount: #{@amount.inspect}, selected: #{@selected.inspect}>"
    end
  end
end

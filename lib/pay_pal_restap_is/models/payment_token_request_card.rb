...
module PayPalRestapIs
  ...
  class PaymentTokenRequestCard < BaseModel
    ...
    def initialize(name = SKIP, number = SKIP, expiry = SKIP,
                   ...
                   billing_address = SKIP, network_transaction_reference = SKIP)
    ...
    def self.from_hash(hash)
      ...
      PaymentTokenRequestCard.new(name,
                                  number,
                                  expiry,
                                  security_code,
                                  type,
    ...
    def inspect
      ...
      " network_transaction_reference: #{@network_transaction_reference.inspect}>"
    end
  end
end

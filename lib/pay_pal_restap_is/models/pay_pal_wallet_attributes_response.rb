...
module PayPalRestapIs
  ...
  class PayPalWalletAttributesResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      PayPalWalletAttributesResponse.new(vault,
                                         cobranded_cards)
    end
    ...
    def to_s
      ...
      "<#{class_name} vault: #{@vault}, cobranded_cards: #{@cobranded_cards}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} vault: #{@vault.inspect}, cobranded_cards: #{@cobranded_cards.inspect}>"
    end
  end
end

...
module PayPalRestapIs
  ...
  class BLIKExperienceContext < BaseModel
    ...
    def self.from_hash(hash)
      ...
      BLIKExperienceContext.new(brand_name,
                                locale,
                                shipping_preference,
                                return_url,
                                cancel_url,
    ...
    def to_s
      ...
      " consumer_ip: #{@consumer_ip}, consumer_user_agent: #{@consumer_user_agent}>"
    end
    ...
    def inspect
      ...
      " cancel_url: #{@cancel_url.inspect}, consumer_ip: #{@consumer_ip.inspect},"\
      " consumer_user_agent: #{@consumer_user_agent.inspect}>"
    end
  end
end

...
module PayPalRestapIs
  ...
  class Phone < BaseModel
    ...
    def self.names
      ...
      @_hash['extension_number'] = 'extension_number'
      @_hash
    end
    ...
    def initialize(country_code = nil, national_number = nil,
                   extension_number = SKIP)
      @country_code = country_code
      @national_number = national_number
      @extension_number = extension_number unless extension_number == SKIP
    end
    ...
    def self.from_hash(hash)
      ...
      extension_number =
        hash.key?('extension_number') ? hash['extension_number'] : SKIP

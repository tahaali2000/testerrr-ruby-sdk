...
module PayPalRestapIs
  ...
  class CapturePaymentInstruction < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      CapturePaymentInstruction.new(platform_fees,
                                    disbursement_mode,
                                    payee_receivable_fx_rate_id)
    end
    ...
    def inspect
      ...
      " #{@disbursement_mode.inspect}, payee_receivable_fx_rate_id:"\
      " #{@payee_receivable_fx_rate_id.inspect}>"
    end
  end
end

...
module PayPalRestapIs
  ...
  class VenmoPaymentToken < BaseModel
    ...
    def self.from_hash(hash)
      ...
      VenmoPaymentToken.new(description,
                            shipping,
                            permit_multiple_payment_tokens,
                            usage_type,
                            customer_type,
    ...
    def to_s
      ...
      " #{@usage_type}, customer_type: #{@customer_type}, email_address: #{@email_address},"\
      " payer_id: #{@payer_id}, name: #{@name}, phone: #{@phone}, address: #{@address}, user_name:"\
      " #{@user_name}>"
    end
    ...
    def inspect
      ...
      " #{@usage_type.inspect}, customer_type: #{@customer_type.inspect}, email_address:"\
      " #{@email_address.inspect}, payer_id: #{@payer_id.inspect}, name: #{@name.inspect}, phone:"\
      " #{@phone.inspect}, address: #{@address.inspect}, user_name: #{@user_name.inspect}>"
    end
  end
end

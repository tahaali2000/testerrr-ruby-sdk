...
module PayPalRestapIs
  ...
  class PaymentTokenRequest < BaseModel
    ...
    # @return [PaymentTokenRequestPaymentSource]
    ...
    def initialize(payment_source = nil, customer = SKIP)
    ...
    def self.from_hash(hash)
      ...
      payment_source = PaymentTokenRequestPaymentSource.from_hash(hash['payment_source']) if
        hash['payment_source']
      customer = CustomerRequest.from_hash(hash['customer']) if hash['customer']

      # Create object from extracted values.
      PaymentTokenRequest.new(payment_source,
                              customer)
    end

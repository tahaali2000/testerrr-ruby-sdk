...
module PayPalRestapIs
  ...
  class ApplePayCardResponse < BaseModel
    ...
    def to_s
      ...
      " expiry: #{@expiry}, bin_details: #{@bin_details}, billing_address: #{@billing_address},"\
    ...
    def inspect
      ...
      " #{@expiry.inspect}, bin_details: #{@bin_details.inspect}, billing_address:"\
      " #{@billing_address.inspect}, country_code: #{@country_code.inspect}>"
    end
  end
end

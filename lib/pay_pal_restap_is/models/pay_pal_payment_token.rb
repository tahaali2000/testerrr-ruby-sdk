...
module PayPalRestapIs
  ...
  class PayPalPaymentToken < BaseModel
    ...
    def self.from_hash(hash)
      ...
      PayPalPaymentToken.new(description,
                             shipping,
                             permit_multiple_payment_tokens,
                             usage_type,
                             customer_type,
    ...
    def to_s
      ...
      " payer_id: #{@payer_id}, name: #{@name}, phone: #{@phone}, address: #{@address},"\
    ...
    def inspect
      ...
      " #{@phone.inspect}, address: #{@address.inspect}, account_id: #{@account_id.inspect},"\

...
module PayPalRestapIs
  ...
  class VaultVenmoRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      VaultVenmoRequest.new(description,
                            shipping,
                            permit_multiple_payment_tokens,
                            usage_type,
                            customer_type,
    ...
    def to_s
      ...
      " #{@usage_type}, customer_type: #{@customer_type}, experience_context:"\
      " #{@experience_context}>"
    end
    ...
    def inspect
      ...
      " #{@usage_type.inspect}, customer_type: #{@customer_type.inspect}, experience_context:"\

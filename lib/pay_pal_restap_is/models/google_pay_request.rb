...
module PayPalRestapIs
  ...
  class GooglePayRequest < BaseModel
    ...
    def initialize(name = SKIP, email_address = SKIP, phone_number = SKIP,
                   card = SKIP, decrypted_token = SKIP,
                   assurance_details = SKIP, attributes = SKIP)
    ...
    def to_s
      ...
      " #{@assurance_details}, attributes: #{@attributes}>"
    end
    ...
    def inspect
      ...
      " #{@decrypted_token.inspect}, assurance_details: #{@assurance_details.inspect}, attributes:"\
      " #{@attributes.inspect}>"
    end
  end
end
